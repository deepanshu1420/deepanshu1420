...
<ul style="color:#8b949e;">
<li>3rd Prize Winner - Smart India Hackathon for developing InsightBot, a Twitter sentiment analyzer using Natural Language Processing (NLP). <strong>(Dec 2023)</strong></li>
