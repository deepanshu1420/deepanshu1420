...
<ul style="color:#8b949e;">
<li>3rd Prize Winner - Smart India Hackathon (SIH) for developing InsightBot, a Twitter sentiment analyzer powered by Natural Language Processing (NLP) to analyze public sentiment trends through social media data. <strong>(Dec 2023)</strong></li>
